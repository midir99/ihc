...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="color:  #FFFFFF; background-color: #3f71b4;">Cambiar contraseña</div>

                <div class="card-body" style="background-color: #abe5ff;">
                <form method="POST" action="{{ url('user/cambiarclave')}}">
                        @csrf

                        <div class="form-group row">
                            <label for="old_password" class="col-md-4 col-form-label text-md-right">{{ __('Contraseña anterior*') }}</label>
